...
type EdgeServerClient interface {
	...
	HandleUpdateClock(ctx context.Context, in *ClockUpdateRequest, opts ...grpc.CallOption) (*ClockUpdateReply, error)
}
...
func (c *edgeServerClient) HandleUpdateClock(ctx context.Context, in *ClockUpdateRequest, opts ...grpc.CallOption) (*ClockUpdateReply, error) {
	out := new(ClockUpdateReply)
	err := c.cc.Invoke(ctx, "/clairvoyant.EdgeServer/HandleUpdateClock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EdgeServerServer interface {
	...
	HandleUpdateClock(context.Context, *ClockUpdateRequest) (*ClockUpdateReply, error)
...
func (UnimplementedEdgeServerServer) HandleUpdateClock(context.Context, *ClockUpdateRequest) (*ClockUpdateReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HandleUpdateClock not implemented")
}
...
func _EdgeServer_HandleUpdateClock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClockUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EdgeServerServer).HandleUpdateClock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clairvoyant.EdgeServer/HandleUpdateClock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EdgeServerServer).HandleUpdateClock(ctx, req.(*ClockUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EdgeServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HandleUpdateClock",
			Handler:    _EdgeServer_HandleUpdateClock_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "clairvoyant.proto",
